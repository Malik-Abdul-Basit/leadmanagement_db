...
class CreateTeleMarketingLeadsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tele_marketing_leads', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('id');
            $table->date('date');
    ...
    {
        Schema::dropIfExists('tele_marketing_leads');
    }
}
